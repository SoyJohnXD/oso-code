...
2. `../_shared/platform/codex/debug.md` — what the flow leaves to the host: the tools it calls, the paths it resolves, the state command, and the parts of this port a later slice still has to fill.
