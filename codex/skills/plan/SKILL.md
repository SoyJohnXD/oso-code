...
- Abandoning this flow mid-run: run `oso-state clear`. The state belongs to the repository and outlives the session — left standing, it arms every gate over later, unrelated work.
