...
2. `${CLAUDE_SKILL_DIR}/../_shared/platform/claude/debug.md` — what the flow leaves to the host: the tools it calls, the paths it interpolates, the delivery rule this TUI imposes, the state command the gates read.
