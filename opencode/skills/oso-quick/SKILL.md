...
2. `../_shared/platform/opencode/quick.md` — what the flow leaves to the host: the delivery contract it speaks under, the question rounds it asks in, the tools it calls, the paths it resolves, the state command, and the installed runtime gates.
