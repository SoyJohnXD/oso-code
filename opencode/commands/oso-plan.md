...
Read the installed wrapper at `~/.config/opencode/skill/oso-plan/SKILL.md` and the
two files it binds, in the order the wrapper states, and follow them as binding.
