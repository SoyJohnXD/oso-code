...
Date: 2026-08-05
Status: accepted
Implemented-in: plugin/skills/_shared/bodies/debt-sweep.md, plugin/skills/_shared/bodies/doubt-pass.md, plugin/skills/_shared/bodies/triage.md, plugin/skills/_shared/bodies/security-pass.md, plugin/skills/_shared/bodies/plan.md, plugin/skills/_shared/bodies/quick.md, plugin/skills/_shared/bodies/debug.md, plugin/agents/oso-integrator.md, tests/plugin-lint.sh, tests/hooks-test.sh, docs/blueprint.md, README.md
