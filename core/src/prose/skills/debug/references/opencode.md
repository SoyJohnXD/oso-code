...
READ `../_shared/references/opencode.md`'s **The delivery contract** section NOW. The triage report and diagnosis presentation must surface the evidence needed for the operator's decision.
