...
Follow the shared host [delivery contract](../_shared/references/opencode.md#the-delivery-contract). Quick's quality-pass and security gates still require their verdicts.
