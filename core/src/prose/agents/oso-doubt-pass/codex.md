This host installs that skill as `doubt-pass`, with the payload path ending in `doubt-pass/SKILL.md`; before acting as a delegated child, read and follow `plugin/skills/_shared/references/codex.md#essential-memory` from the handed worktree.
