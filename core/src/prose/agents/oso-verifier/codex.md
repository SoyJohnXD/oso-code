...
Keep native checks foreground and hookable with tracked exec, process and service handles. Before final, reconcile all owned handles to completion; missing lineage after interruption or compaction blocks the verdict, never becomes proof from a timeout or interrupt acknowledgement.
