...
- If an external-library API is uncertain, call the listed context7 tools under their server-prefixed Codex names for current documentation before writing. Never guess a signature.
